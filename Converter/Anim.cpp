...
namespace Azul
{
	...
	void ANIM::CreateAnim(Model &model, const char *const pTargetName)
	{
		...
		//Trace::out("\n\n");
		// SO let's compress on the fat format....
	...
	// This iterates the whole clip...
	//void ANIM::Compress()
	//{
	//	std::vector<Vec4> clipDegrees = getClipDegrees();

		//int iter = 0;
		//int max = fatClip.size();
		//while (iter)
		//{
		//	// Indexing may get funny here.... let's do a while loop....
		//	if (LocallyCompressible(iter))
		//	{
		//		int size = fatClip.size();
		//		int removeMe = size / 2;
		//		RemoveFrames(removeMe, fatClip);
		//	}
		//	else
		//	{
		//		iter++;
	...
	// This checks if the bone is removable...
	//bool ANIM::LocallyCompressible(int index)
	//{
	//	std::vector<Azul::Frame> fatClip = this->clip.vectorClip;

	//	std::vector<Vec4> clipDegrees = generateClipDe

	//	if (index == 0 && index == fatClip.size())
	//	{
	...
	//	status = localMin(index);
	//	status = localMax(index);

	//	return status;

	//};

	// This checks if the bone is a local min...
	//bool ANIM::localMin(int index)
	//{
	//	std::vector<Azul::Bone> fatFrame = this->clip.vectorClip[index].vectorBone;
	//	// Based on Quat...
	//	
	//	// Based on Trans...
	...
	//// This checks if the bone is a local max...
	//bool ANIM::localMax(int index)
	//{
	//	std::vector<Azul::Bone> fatFrame = this->clip.vectorClip[index].vectorBone;
	//	// Based on Quat...
	...
	//void ANIM::RemoveFrames(int index, std::vector<Azul::Frame>& inData)
	//{
	//	auto it = inData.begin() + index;

	//	inData.erase(it);
	//}

	//std::vector<Vec4> ANIM::getClipDegrees()
	//{
	//	std::vector<Vec4> clipDegrees;

	//	int max = clip.vectorClip.size();
	//	for (int i = 0; i < max; i++)
	//	{
	//		// iterate through every frame...

	//		clipDegrees = getDegreeBend(i);

	//	}
	//}

	//Vec4 ANIM::getDegreeBend(int index)
	//{
