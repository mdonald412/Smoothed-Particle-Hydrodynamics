...
namespace Azul
{
	...
	StringThis::StringThis(AnimController::Name status)
	{
		switch (status)
		{
		case AnimController::Name::AnimController_01:
			strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(AnimController::AnimController_01));
			break;

		case AnimController::Name::AnimController_02:
			strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(AnimController::AnimController_02));
			break;

		case AnimController::Name::Null:
			strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(AnimController::Null));
			break;
