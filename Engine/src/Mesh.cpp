...
namespace Azul
{
	...
	void Mesh::RenderInstances(int instanceCount)
	{
		// ---------------------------------------------
		//    Set (point to ) Index buffer 
		//    Render configuration: Triangles
		...
		DirectXDeviceMan::GetContext()->DrawIndexedInstanced(numIndices, instanceCount, 0, 0, 0);
		//DirectXDeviceMan::GetContext()->DrawIndexedInstanced(numIndices, instanceCount, 0, 0, 1);
	}
